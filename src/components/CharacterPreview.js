  ...
  return (
    <div className="character-preview">
      ...
      <div className="stats">
        ...
        <p><span className="label">Dexterity:</span> {stats.dexterity}</p>
        <p><span className="label">Constitution:</span> {stats.constitution}</p>
        <p><span className="label">Intelligence:</span> {stats.intelligence}</p>
        <p><span className="label">Wisdom:</span> {stats.wisdom}</p>
        <p><span className="label">Charisma:</span> {stats.charisma}</p>
      </div>
    </div>
  );
};
